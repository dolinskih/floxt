...
WINRT_EXPORT namespace winrt::Windows::System::Power
{
    ...
    enum class EnergySaverStatus2 : std::int32_t
    {
        Unknown = 0,
        Off = 1,
        Standard = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::System::Power::IPowerManagerStatics2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_EnergySaverStatus2(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsEnergySaverStatus2Supported(bool*) noexcept = 0;
            virtual std::int32_t __stdcall add_EnergySaverStatus2Changed(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_EnergySaverStatus2Changed(winrt::event_token) noexcept = 0;
        };
    };
    template <typename D>
