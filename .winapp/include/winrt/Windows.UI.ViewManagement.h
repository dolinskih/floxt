...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        void* result{};
        consume_general<winrt::Windows::UI::ViewManagement::IUIViewSettingsStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::ViewManagement::IUIViewSettingsStatics>::GetForCurrentView, &result);
