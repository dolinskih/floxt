...
{
    enum class PlatformAutomaticAppSignInPolicy : std::int32_t
    {
        Unknown = 0,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::System::Profile::IPlatformAutomaticAppSignInManagerStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Policy(std::int32_t*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::System::Profile::IRetailInfoStatics2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_IsDemoModeEnabledEx(bool*) noexcept = 0;
        };
    };
