...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        void* operation{};
        consume_general<winrt::Windows::ApplicationModel::Contacts::Provider::IContactProvider, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Contacts::Provider::IContactProvider>::GetContactFromRemoteIdAsync, *(void**)(&contactRemoteId), &operation);
    ...
    {
        void* value{};
        consume_general<winrt::Windows::ApplicationModel::Contacts::Provider::IContactProvider, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Contacts::Provider::IContactProvider>::get_ContactListId, &value);
    ...
    {
        std::int32_t __stdcall GetContactFromRemoteIdAsync(void* contactRemoteId, void** operation) noexcept final try
        {
            clear_abi(operation);
            typename D::abi_guard guard(this->shim());
