...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::UI::Shell::Tasks::IAppTaskInfo>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall GetCompletedSteps(std::uint32_t* __resultSize, void***) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::UI::Shell::Tasks::IAppTaskInfoStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall FindAll(std::uint32_t* __resultSize, void***) noexcept = 0;
