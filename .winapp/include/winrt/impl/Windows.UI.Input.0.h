...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::UI::Input::IGamepadNavigationConfiguration>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_NavigationEnabled(bool*) noexcept = 0;
            virtual std::int32_t __stdcall TrySetNavigationEnabled(bool, bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::UI::Input::IGamepadNavigationConfigurationStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall TryGetForCurrentProcess(void**) noexcept = 0;
