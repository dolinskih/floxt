...
// Props definition for the ExitWarningModal component
...
export default function ExitWarningModal({
    ...
    return (
        // Render within the animated dialog container handling backdrop blur and transitions
        <AnimatedDialog isOpen={isOpen} onClose={onClose} className="max-w-md">
            {/* Modal card container with theme-aware background, borders, and drop shadow */}
            <div className="bg-white dark:bg-neutral-900 border border-neutral-300 dark:border-neutral-700 rounded-2xl shadow-2xl p-6 flex flex-col items-center text-center">
                ...
                {/* Message body: Contextual warning based on single file vs project-wide unsaved status */}
                ...
                {/* Action buttons: Cancel to stay vs Confirm to discard changes and exit */}
                <div className="flex items-center justify-center gap-4 w-full">
                    {/* Dismiss dialog without exiting */}
                    <button
                        onClick={onClose}
                    ...
                    {/* Destructive action to bypass unsaved changes */}
                    <button
