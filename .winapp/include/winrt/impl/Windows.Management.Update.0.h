...
WINRT_EXPORT namespace winrt::Windows::Management::Update
{
    ...
    enum class WindowsSoftwareUpdateCategory : std::int32_t
    {
        Other = 0,
        Application = 1,
        Driver = 2,
    ...
    enum class WindowsSoftwareUpdateIdentityType : std::int32_t
    {
        ProductCode = 0,
        PackageFamilyName = 1,
    };
    ...
    enum class WindowsUpdateManagerScanMode : std::int32_t
    {
        Default = 0,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Management::Update::IWindowsSoftwareUpdate>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_UpdateCategory(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_UpdateIdentity(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Management::Update::IWindowsSoftwareUpdateFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateInstance(void*, std::int32_t, void*, void*, void*, void*, std::uint64_t, std::uint64_t, void*, void*, void*, void*, void*, void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Management::Update::IWindowsSoftwareUpdateProvider>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_SchemaVersion(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Management::Update::IWindowsUpdateManager2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_ProviderIds(std::uint32_t* __valueSize, void***) noexcept = 0;
            virtual std::int32_t __stdcall GetApplicableSoftwareUpdates(void**) noexcept = 0;
            virtual std::int32_t __stdcall PerformScan(std::int32_t, void**) noexcept = 0;
        };
    };
