...
namespace Microsoft.WindowsAppSDK
{
    ...
    internal class Release
    {
        ...
        internal const uint MajorMinor = 0x00020005;
        ...
        namespace Packages
        {
            ...
            namespace DDLM
            {
                internal class X86
                {
                    ...
                    internal const string PackageFamilyName = "Microsoft.WinAppRuntime.DDLM.2.5.1.0-x8_8wekyb3d8bbwe";
                }
                internal class X64
                {
                    /// The Windows App SDK runtime's Dynamic Dependency Lifetime Manager (DDLM) package's family name, for x64.
                    internal const string PackageFamilyName = "Microsoft.WinAppRuntime.DDLM.2.5.1.0-x6_8wekyb3d8bbwe";
                }
                internal class Arm64
                {
                    ...
                    internal const string PackageFamilyName = "Microsoft.WinAppRuntime.DDLM.2.5.1.0-a6_8wekyb3d8bbwe";
                }
            }
        }
    }
