...
WINRT_EXPORT namespace winrt::Windows::UI::Notifications
{
    ...
    enum class ToastNotificationMode : std::int32_t
    {
        Unrestricted = 0,
        PriorityOnly = 1,
        AlarmsOnly = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::UI::Notifications::IToastNotificationManagerForUser3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_NotificationMode(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall add_NotificationModeChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_NotificationModeChanged(winrt::event_token) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::UI::Notifications::IToastNotificationStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_IsExpandableContentSupported(bool*) noexcept = 0;
        };
    };
