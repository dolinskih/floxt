...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        bool value{};
        consume_general<winrt::Windows::Storage::Search::IQueryOptionsAdditionalSearchSources, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Storage::Search::IQueryOptionsAdditionalSearchSources>::get_IncludeLocalSemanticIndex, &value);
        return value;
    }
    ...
    {
        bool value{};
        consume_general<winrt::Windows::Storage::Search::IQueryOptionsAdditionalSearchSources, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Storage::Search::IQueryOptionsAdditionalSearchSources>::get_IncludeCloudProviders, &value);
        return value;
    }
    ...
    {
        std::int32_t __stdcall get_IncludeLocalSemanticIndex(bool* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall get_IncludeCloudProviders(bool* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
