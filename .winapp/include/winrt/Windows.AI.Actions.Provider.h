...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        void* operation{};
        consume_general<winrt::Windows::AI::Actions::Provider::IActionFeedbackHandler, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::AI::Actions::Provider::IActionFeedbackHandler>::ProcessFeedbackAsync, *(void**)(&context), *(void**)(&feedback), &operation);
    ...
    {
        void* operation{};
        consume_general<winrt::Windows::AI::Actions::Provider::IActionProvider, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::AI::Actions::Provider::IActionProvider>::InvokeAsync, *(void**)(&context), &operation);
        return winrt::Windows::Foundation::IAsyncAction{ operation, take_ownership_from_abi };
    }
    template <typename D>
    ...
    {
        std::int32_t __stdcall ProcessFeedbackAsync(void* context, void* feedback, void** operation) noexcept final try
        {
            clear_abi(operation);
